...
It is NOT on the public service yet. so the system is uncomplete and unstable.
Please refer the situation, if you want to try it.

- You can test the Comment SaaS function by adding `<script src="//5ay.it/now.js>` on your website.
...
The next version of the prototype will be release on early Mar. 2022.
Also, we're planning to start the Public Beta from Jun. 2022.
